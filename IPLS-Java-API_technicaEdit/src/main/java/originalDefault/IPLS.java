...
public class IPLS {
    ...
    public void Send_Gradient_Partition(int Partition, Map<Integer,List<Double>> GradientPartitions) throws Exception {
    	//System.out.println("        *** SEND_GRADIENT 1");
    	...
    	//System.out.println("        *** SEND_GRADIENT FINISHED");
    ...
    public void SendGradients(List<Integer> Partitions,Map<Integer,List<Double>> GradientPartitions) throws Exception {
    	//System.out.println("    *** SEND GRADIENT 1");
        PeerData.SendMtx.acquire();
        PeerData.mtx.acquire();
    	...
    	//System.out.println("    *** SEND GRADIENT 2");
    	...
    	//System.out.println("    *** SEND GRADIENT FINISHED");
    }
    ...
    public void UpdateGradient(List<Double> Gradients) throws Exception {  
    	//System.out.println("%%% UPDATE GRADIENT 1");
        int i,j;
    	...
    	//System.out.println("%%% UPDATE GRADIENT 2");
    	...
    	//System.out.println("%%% UPDATE GRADIENT 3");
    	...
    	//System.out.println("%%% UPDATE GRADIENT 4");
        //System.out.println("SENDING GRADIENTS COMPLETED !! :) ");

    	//System.out.println("        IPLS 4");
    	...
    	//System.out.println("        IPLS 5");

        
        // Wait to get updated partitions that i am not responsible for
        while(PeerData.Wait_Ack.size() != 0){
        	Thread.yield();
        }

    	//System.out.println("%%% UPDATE GRADIENT 5");
    	...
    	//System.out.println("%%% UPDATE GRADIENT FINISHED");
        
    	//System.out.println("        IPLS 7");
